...
namespace START {
  ...
  public:
    ...
    /*inline std::vector<double> GetVectorEnergy() const {return fVectorEnergy;}
     ...
     inline std::vector<double> GetVectorInterBiais() const {return fVectorInterBiais;}*/
    ...
    inline const std::vector<double> &GetVectorEnergy() const {return fVectorEnergy;}
    inline const std::vector<double> &GetVectorArea() const {return fVectorArea;}
    inline const std::vector<double> &GetVectorResolution() const {return fVectorResolution;}
    inline const std::vector<double> &GetVectorBiais() const {return fVectorBiais;}
    inline const std::vector<double> &GetVectorInterEnergy() const {return fVectorInterEnergy;}
    inline const std::vector<double> &GetVectorInterArea() const {return fVectorInterArea;}
    inline const std::vector<double> &GetVectorInterResolution() const {return fVectorInterResolution;}
    inline const std::vector<double> &GetVectorInterBiais() const {return fVectorInterBiais;}
    ...
    std::map< double, std::pair< std::vector<double>, std::vector<double> > > GetDistributionVectorTable() const {return fDistributionInstrumentMapTable;}
    ...
    void DisplayEnergyResolution(); // *MENU*
